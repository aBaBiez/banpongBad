...
export default async function handle(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        SELECT
            ...
            bs.court_price
        FROM buffet b
        LEFT JOIN buffet_setting bs ON bs.isStudent = b.isStudent
        WHERE b.id = ?
        LIMIT 1
        `;
        ...
        `;
        const [customerRows] = await connection.query<RowDataPacket[]>(customerQuery, [buffetId, buffetStatusEnum.BUFFET]);
